...
export class reviewPaymentReport1 extends Component {
...
reviewPaymentReport1.template = "yousentech_sale_reports.dy_report_review_payment_temp1";
reviewPaymentReport1.events={
...
registry.category("actions").add("yousentech_sale_reports.payment_re", reviewPaymentReport1);
